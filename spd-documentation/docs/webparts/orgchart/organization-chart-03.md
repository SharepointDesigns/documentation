...
![Orgchart 2](assets/orgchart3.png)
...
<details>
<summary>📸 View Filter Settings Screenshots</summary>

![Filter Settings](assets/orgfilter.png)

</details>

| **Name**                     | **Purpose**                                                                          | **Example** |
| ---------------------------- | ------------------------------------------------------------------------------------ | ----------- |
| Enable Category Settings | Toggles the visibility of the category filter.                                       | On / Off    |
| Filter Field             | Defines which option (e.g., Job Title, Location) will appear in the category filter. | Dropdown    |
