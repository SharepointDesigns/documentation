...
![](assets/screenshot-2025-11-18-184142.png)
...
![General Settings](assets/screenshot-2025-11-18-184259.png)

</details>

| Name                | Purpose                                                              | Example / Options                         |
| ------------------- | -------------------------------------------------------------------- | ----------------------------------------- |
| Autoplay        |          Toggle on to set the frequent set of carousel          | On / Off    |
| Autoplay duration (seconds)    | Set how frequent the News will scroll the carousel                             | Slider |
...
![layout settings](assets/screenshot-2025-11-18-184345.png)
