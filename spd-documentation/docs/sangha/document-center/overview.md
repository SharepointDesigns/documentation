...
| --- | ----------------------- | ------------------------------------------------------------------------------------------------------ |
| 1   | Document Welcome Banner | Hero banner with a background image and department/page title                                          |
| 2   | Document Contents       | Surfaces documents from one or more SharePoint libraries in Grid view                                  |
