...
## Version - 1.0.0.6
- - -
* ### Property Pane Color & Image Picker Upgrade: 
All web parts (Featured News, Quick Links, FAQs, People Search, RSS Feeds, Upcoming Events Calendar) now share a single upgraded color picker and image picker control for a more consistent property pane experience.
* ### Quick Links Dark Gradient Background: 
Added a dark gradient background option for the Quick Links web part.
* ### Upcoming Events Calendar Improvements: 
Improved the empty "no events" state and refined event date styling for better layout consistency.
* ### Featured News Hover Color Fix: 
Hover color theme settings are now scoped to each Featured News web part instance individually, instead of leaking across every instance on the page.
* ### Branding & Style Refinements: 
Font-family, border-radius, and out-of-the-box theme consistency updates across web parts, plus footer styling fixes.
* ### General Fixes: 
Assorted style and stability fixes across the News, Calendar, and RSS Feeds web parts, and calendar preview refinements.
