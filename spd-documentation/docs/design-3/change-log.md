...
* 🔄 Enhanced LicenseHelper to pass new props for user data, enabling improved user-specific handling and seamless integration across components
* 🔄 Propagated the updated props across all WebPart files to ensure consistent data flow and unified behavior throughout the solution
