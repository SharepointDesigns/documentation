...
* Click **Apply** to activate the dynamic connection\[1]\[6].

> **Important:** After editing and configuring this web part, you must click **Apply** on the property pane to save and reflect your changes\[2]\[7].
...
* **Dynamic Filtering** allows you to connect this library to another list or library web part for contextual, real-time filtering based on user selection\[1]\[6].
