...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    title: "Design 3",
    imageUrl:
      "https://raw.githubusercontent.com/SharepointDesigns/refs/heads/Deploy-Automate/spd-documentation/static/img/uploads/diy-3-latest.png",
    // buttonLabel: 'Customize',
  ...
  return (
    <div className={clsx("col col--4", styles.featureBox)}>
      <div className={clsx("text--center", styles.contentContainer)}>
        ...
        {/* <h3>{title}</h3> */}
        <a
          className={clsx("button button--primary", styles.redirectButton)}
          href={buttonLink}
        >
          {title}
        </a>
